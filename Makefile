...
package:
	tar -czf $(APP_NAME)-standalone.tar.gz Makefile go.mod go.sum main.go directives.go plugin Corefile Corefile.prod Corefile.example coredns-ecs.service coredns-ecs@.service README.md
